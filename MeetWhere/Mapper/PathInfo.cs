...
namespace Mapper
{
    public class PathInfo
    {
        ...
        private class PathParser
        {
            ...
            public PathParser(string dv, double scale)
            {
                ...
                foreach (var pathpart in pathData)
                {
                    pathpart.point = new Point(pathpart.point.X * scale, pathpart.point.Y * scale);
                    if (pathpart.size.HasValue)
                        pathpart.size = new Point(pathpart.size.Value.X * scale, pathpart.size.Value.Y * scale);
                }
            }
